...
uint256 hashGenesisBlock("0x552abcf51749eac1b15b3f0ebfbe884a7cdbf5952a46caba507e7d02f738a8f9");
...
const string strMessageMagic = "STMCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 7 * 24 * 60 * 60; // STMCoin: 7 days
static const int64 nTargetSpacing = 300; // STMCoin: 5 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal stmcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "STMCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x552abcf51749eac1b15b3f0ebfbe884a7cdbf5952a46caba507e7d02f738a8f9");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Compiled Sat, Feb 15th 2014.  11:21 AM Central Time.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1392484827; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 360751;

        if (fTestNet)
        {
            block.nTime    = 1392501035;
            block.nNonce   = 360751;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x3d19b1d695269b3336b02faf350d91c714124616029d9323e5c046da5155b1db"));
